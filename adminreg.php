...
//         }
        ...
        // }
$result=mysqli_query($con,"select * from doctab");
$rows=mysqli_num_rows($result);
echo "<i style='color:blue'></i>";
echo "<i style='color:blue'></i>";
echo "<i style='color:red',font-size=15px>Doctors who are present for the free health campaign</i>";
echo "<table ><tr><th>Name</th><th>Specialization</th><th>ID</th></tr>";
